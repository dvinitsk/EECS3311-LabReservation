...
import com.yorku.lab.pattern.strategy.DebitPaymentStrategy;

public class DebitPaymentStrategyAITest {
    ...
    @Test
    public void testMethodIsDebit() {
        PaymentTransaction t = strategy.pay(10.0);
        assertEquals(PaymentMethod.DEBIT, t.getMethod());
    }
